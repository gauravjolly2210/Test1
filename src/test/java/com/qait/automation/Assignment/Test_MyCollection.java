...
import com.qait.automation.Assignment.MyCollection;
...
public class Test_MyCollection {
	...
	public void Test2_Duplicate_Entry_In_Collection(){
		...
		Assert.assertTrue(dynamicArray.add("Test"),"Assertion Failed : Add Duplicate Entry functionality is not working fine");
